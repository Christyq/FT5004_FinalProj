...
contract ERC20 {
  ...
  */
  ...
  function DTtransferFrom(address _from, address _spender, address _to, uint256 _value) public returns (bool) {
    require(_to != address(0));
    require(_value <= balances[_from], "From doesn't have enough balance");
  ...
  function DTapprove(address _owner, address _spender, uint256 _value) public returns (bool) {
